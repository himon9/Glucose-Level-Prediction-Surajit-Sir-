...
plt.plot([], color='red', label='Severe, [190 < Glucose Level]')
plt.plot([], color='blue', label='Medium, [160 < Glucose Level <= 190]')
plt.plot([], color='green', label='Normal, [Glucose Level <= 160]')
plt.legend()
...
plt.title(r'Linear Regressor Eq : $\ W=\left(X^TX\right)^{-1}X^TY$')
